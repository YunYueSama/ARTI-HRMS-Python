...
class TraceRecord(BaseModel):
    ...
    feedback: Optional[int] = Field(default=None, description="用户反馈（1=好, -1=差）")
...
class TraceQuery(BaseModel):
    """追踪查询参数模型"""
    user_id: Optional[int] = Field(default=None, description="按用户 ID 过滤")
    start_time: Optional[datetime] = Field(default=None, description="开始时间")
    end_time: Optional[datetime] = Field(default=None, description="结束时间")
    status: Optional[Literal["success", "error", "slow"]] = Field(default=None, description="按状态过滤")
    operation_type: Optional[Literal["chat", "agent", "rag"]] = Field(default=None, description="按操作类型过滤")
    feedback: Optional[Literal["up", "down"]] = Field(default=None, description="按反馈过滤")
