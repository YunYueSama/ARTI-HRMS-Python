...
class DraftPlan(BaseModel):
    ...
    summary: Optional[str] = Field(default=None, description="操作摘要描述")
    action: Optional[str] = Field(default=None, description="具体动作")
    # 请假相关字段
    ...
    # 考勤相关字段
    attendance_date: Optional[str] = Field(default=None, description="考勤日期")
    clock_in: Optional[str] = Field(default=None, description="签到时间")
    clock_out: Optional[str] = Field(default=None, description="签退时间")
    # 权限相关字段
...
class AgentPlanStep(BaseModel):
    ...
    payload_preview: dict[str, Any] = Field(
        alias="payloadPreview", default_factory=dict, description="请求参数预览"
    )
...
class AgentPlanEntity(BaseModel):
    ...
    id: Optional[int] = Field(default=None, description="实体ID")
...
class AgentTaskView(BaseModel):
    ...
    command_text: Optional[str] = Field(default=None, description="用户原始指令")
    ...
    executable: Optional[bool] = Field(default=None, description="是否可执行")
    plan: Optional[AgentPlan] = Field(default=None, description="执行计划")
    result_summary: Optional[str] = Field(default=None, description="执行结果摘要")
